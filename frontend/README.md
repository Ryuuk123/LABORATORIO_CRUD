...
React + Vite para cpnsumir el backend del laboratorio.
...
Login → AuthContext → JWT en localStorage → `api.js` agrega Bearer token → backend verifica JWT → autenticacion por rol.
